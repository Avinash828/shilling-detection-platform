...
<div>
 <table class="table table-hover table-bordered">
  ...
  <tr>
   ...
   <tr>
	<td scope="row">BayesDetector</td>
    <td>Dou, T., Yu, J., Xiong, Q., Gao, M., Song, Y., & Fang, Q.  Collaborative Shilling Detection Bridging Factorization and User Embedding. (2018) <br></td>
  </tr>
  </table>
</div>
